        ...
        fontsDir.listFiles()?.forEach { file ->
            ...
            if (!fileName.startsWith(".")) {
                ...
                if (fontDef.main.keys.none { it == fontName }) {
                    Log.i("Saukko", "Deleting font file: $fileName")
                    file.delete()
                }
            }
        }
            ...
            fontDef.main.keys.map { name ->
                async {
                    ...
                    try {
                        ...
                        Log.e("Saukko", "Failed to download fonts ($name from $url)", e)
                    }
                }
            }.awaitAll()
        } 
